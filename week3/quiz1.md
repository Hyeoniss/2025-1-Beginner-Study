...
- 답: 
        ...
        Create a merge commit: 브랜치를 병합하면서 별도의 병합 커밋을 생성함

        Squash and merge: 여러 커밋을 하나로 압축(squash)하여 병합함

        Rebase and merge: 커밋들을 다른 브랜치 기준으로 재배열한 뒤 병합함 (히스토리 깔끔)
...
- 답: 
        ...
        revert : reset은 히스토리를 되돌려버리기 때문에 GitHub에 푸시한 경우 다른 사람들과의 히스토리가 충돌할 수 있기 떄문이다. 